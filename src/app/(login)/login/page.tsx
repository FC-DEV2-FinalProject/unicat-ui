      ...
      <div className="w-[40%]">
        <div className="w-[350px] flex flex-col items-center justify-center h-full mx-auto">
          ...
          <div className="flex flex-col items-center gap-4 w-full">
            <button className="flex h-[52px] px-6 py-3 justify-center items-center gap-2.5 self-stretch rounded-lg bg-[#C7C7C7]">
              로그인
            </button>
            <button className="flex h-[52px] px-6 py-3 justify-center items-center gap-2.5 self-stretch rounded-lg bg-[#FEE500]">
              <img src="/images/KaKao.svg" alt="카카오 로그인 아이콘" />
              카카오 로그인
            </button>
            <button className="flex h-[52px] px-6 py-3 justify-center items-center gap-2.5 self-stretch rounded-lg bg-[#F2F2F2]">
